...
class Validator final {
 public:
  ...
  typedef WithAsyncMethod_EstablishCon<WithAsyncMethod_GiveVariables<Service > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_EstablishCon<WithCallbackMethod_GiveVariables<Service > > CallbackService;
